...
export default class Game implements IGame {
	...
	public resetStatistics(): void {
		const playerStatElem = document.querySelector("[data-player=\"player\"] > .statistics__value");
		const aiStatElem = document.querySelector("[data-player=\"AI\"] > .statistics__value");
